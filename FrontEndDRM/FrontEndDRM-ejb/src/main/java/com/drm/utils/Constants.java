...
//    public static final String SUFFIX_JSF_PAGE_EXTENSION = "jsf";
    ...
    public static enum SYSTEM_ERRORS {
        BACKEND_INVOKATION_ERROR("FD_LS_1000",
                "Unexpected error when calling backend service"), GENERAL_ERROR(
                "FD_LS_1001", "General error"), UNKOWN_ERROR("FD_LS_1002",
                "Unexpected error"), USER_NOT_LOGGED_IN_ERROR("FD_LS_1003",
                "User is not logged in"), USER_SESSION_TIMEOUT_ERROR(
                "FD_LS_1004", "User session timeout out has been reached"), INVALID_INPUT_ERROR(
                "FD_LS_1005",
                "User input is invalid, please chack the input values"), INVALID_TRANSACTION_PASSWORD_ERROR(
                "FD_LS_1006", "User transaction password is invalid"), INVALID_USER_PACKAGE_ERROR(
                "FD_LS_1007",
