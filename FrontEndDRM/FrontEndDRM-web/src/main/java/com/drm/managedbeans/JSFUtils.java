...
public class JSFUtils {
    ...
    public static String getRequestParamValue(String requestParamName) {
        return getExternalContext().getRequestParameterMap().get(
                requestParamName);
    }
    ...
    public static FacesMessage addFacesMessage(String msgContent,
            Severity msgSeverity) {
        return addFacesMessage(null, msgContent, msgSeverity);
    }

    public static FacesMessage addFacesMessage(String msgId, String msgContent,
            Severity msgSeverity) {
        return addFacesMessage(msgId, msgContent, null, msgSeverity);
    }

    public static FacesMessage addFacesMessage(String msgId, String msgContent,
            String msgDetails, Severity msgSeverity) {
        FacesMessage facesMessage = getFacesMessage(msgContent, msgDetails,
                msgSeverity);
        getFacesContext().addMessage(msgId, facesMessage);
        return facesMessage;
    }

    public static FacesMessage getFacesMessage(String msgContent,
            String msgDetails, Severity msgSeverity) {
        FacesMessage facesMessage = new FacesMessage(msgSeverity, msgContent,
                msgDetails);
        return facesMessage;
    }
