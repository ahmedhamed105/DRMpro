 ...
 */
@Entity
@Table(name = "audit", catalog = "GuardianPro", schema = "")
@XmlRootElement
@NamedQueries({
...
public class Audit implements Serializable {
    ...
    @NotNull
    @Size(min = 1, max = 45)
    @Column(name = "action_result", nullable = false, length = 45)
    private String actionResult;
    @Basic(optional = false)
    @NotNull
    @Size(min = 1, max = 250)
    @Column(name = "action_value", nullable = false, length = 250)
    ...
    public String toString() {
        return "com.guardianpro.drm.entities.Audit[ auditId=" + auditId + " ]";
    }
