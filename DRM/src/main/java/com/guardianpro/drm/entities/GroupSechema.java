 ...
 */
@Entity
@Table(name = "group_sechema", catalog = "drmpro", schema = "")
@XmlRootElement
@NamedQueries({
...
public class GroupSechema implements Serializable {
    ...
    public GroupSechema(Integer id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof GroupSechema)) {
            return false;
        }
        GroupSechema other = (GroupSechema) object;
    ...
    public String toString() {
        return "com.guardianpro.drm.entities.GroupSechema[ id=" + id + " ]";
    }
