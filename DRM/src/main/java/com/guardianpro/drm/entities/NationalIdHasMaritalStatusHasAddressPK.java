...
public class NationalIdHasMaritalStatusHasAddressPK implements Serializable {
    ...
    public String toString() {
        return "com.guardianpro.drm.entities.NationalIdHasMaritalStatusHasAddressPK[ nationalIDhasMaritalstatusNationalIDID=" + nationalIDhasMaritalstatusNationalIDID + ", nationalIDhasMaritalstatusMaritalstatusID=" + nationalIDhasMaritalstatusMaritalstatusID + ", addressID=" + addressID + " ]";
    }
