 ...
 */
@Entity
@Table(name = "terminal_parser_log", catalog = "drmpro", schema = "")
@XmlRootElement
@NamedQueries({
...
public class TerminalParserLog implements Serializable {
    ...
    @NotNull
    @Size(min = 1, max = 50)
    @Column(name = "DT", nullable = false, length = 50)
    private String dt;
    @Basic(optional = false)
    @NotNull
    @Size(min = 1, max = 45)
    ...
    @NotNull
    @Size(min = 1, max = 45)
    @Column(name = "ERR", nullable = false, length = 45)
    private String err;
    ...
    public String toString() {
        return "com.guardianpro.drm.entities.TerminalParserLog[ id=" + id + " ]";
    }
