 ...
 */
@Entity
@Table(name = "national_id_has_marital_status_has_address", catalog = "drmpro", schema = "")
@XmlRootElement
@NamedQueries({
...
public class NationalIdHasMaritalStatusHasAddress implements Serializable {
    ...
    public String toString() {
        return "com.guardianpro.drm.entities.NationalIdHasMaritalStatusHasAddress[ nationalIdHasMaritalStatusHasAddressPK=" + nationalIdHasMaritalStatusHasAddressPK + " ]";
    }
