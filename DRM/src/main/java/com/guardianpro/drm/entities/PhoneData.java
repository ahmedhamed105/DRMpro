 ...
 */
@Entity
@Table(name = "phone_data", catalog = "drmpro", schema = "")
@XmlRootElement
@NamedQueries({
...
public class PhoneData implements Serializable {
    ...
    public PhoneData(Integer id, String telephone, Date createDate, Date updateDate) {
        this.id = id;
    ...
    public String toString() {
        return "com.guardianpro.drm.entities.PhoneData[ id=" + id + " ]";
    }
