 ...
 */
@Entity
@Table(name = "birth_data", catalog = "drmpro", schema = "")
@XmlRootElement
@NamedQueries({
...
public class BirthData implements Serializable {
    ...
    @Size(max = 45)
    @Column(name = "Birth_Cert", length = 45)
    ...
    public BirthData(Integer id, Date birthDate, Date createDate, Date updateDate) {
        this.id = id;
    ...
    public String toString() {
        return "com.guardianpro.drm.entities.BirthData[ id=" + id + " ]";
    }
