 ...
 */
@Entity
@Table(name = "national_id_has_marital_status1", catalog = "drmpro", schema = "")
@XmlRootElement
@NamedQueries({
...
public class NationalIdHasMaritalStatus1 implements Serializable {
    ...
    public String toString() {
        return "com.guardianpro.drm.entities.NationalIdHasMaritalStatus1[ nationalIdHasMaritalStatus1PK=" + nationalIdHasMaritalStatus1PK + " ]";
    }
